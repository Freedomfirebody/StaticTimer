...
public abstract class AbstractTimerProcessor<Annot extends Annotation> {
     ...
     * com.lewis.util.ppa.timer.TimeCalculate.TimeDetail
     * 对等结构体如下
     * treeMaker.Select(
     *      treeMaker.Select(
     *          treeMaker.Select(
     ...
     *                  treeMaker.Select(
     *                      treeMaker.Select(
     *                          treeMaker.Ident(elementUtils.getName("com")),
     *                          elementUtils.getName("lewis")
     *                      ),
     *                      elementUtils.getName("util")
     *                  ),
     *                  elementUtils.getName("ppa")
     *              ),
     *              elementUtils.getName("timer")
     *          ),
